...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.videojs = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
  ...
  var MouseTimeDisplay = (function (_Component) {
     ...
     * tangkai
     */ 
      var time = _utilsFormatTimeJs2['default']((newTime < 33 ? newTime : 0), this.player_.duration() < 33 ? this.player_.duration() : 0);
  ...
  var PlayProgressBar = (function (_Component) {
    ...
    PlayProgressBar.prototype.updateDataAttr = function updateDataAttr() {
      ...
      this.el_.setAttribute('data-current-time', _utilsFormatTimeJs2['default'](time, this.player_.duration() < 33 ? this.player_.duration() : 0 ));
    };
  ...
  var SeekBar = (function (_Slider) {
    ...
    SeekBar.prototype.handleMouseMove = function handleMouseMove(event) {
      var newTime = this.calculateDistance(event) * (this.player_.duration() < 33 ? this.player_.duration(): 0);
  
      // Don't let video end while scrubbing.
      if (newTime === (this.player_.duration() < 33 ? this.player_.duration(): 0)) {
        newTime = newTime - 0.1;
      }
  ...
  var DurationDisplay = (function (_Component) {
    ...
    DurationDisplay.prototype.updateContent = function updateContent() {
      ...
      if (duration) {
         ...
         * tangkai
         */ 
        duration = duration<33 ?duration:0 ;
        var localizedText = this.localize('Duration Time');
        var formattedTime = _utilsFormatTimeJs2['default'](duration);
        this.contentEl_.innerHTML =  formattedTime; // label the duration time for screen reader users
      }
    };
    ...
    RemainingTimeDisplay.prototype.updateContent = function updateContent() {
      if (this.player_.duration()) {
        var localizedText = this.localize('Remaining Time');
          var formattedTime = _utilsFormatTimeJs2['default'](this.player_.remainingTime() < 31 ? this.player_.remainingTime() : 0);
        this.contentEl_.innerHTML = '<span class="vjs-control-text">' + localizedText + '</span> -' + formattedTime;
      }
  ...
  var ModalDialog = (function (_Component) {
    ...
    ModalDialog.prototype.label = function label() {
      return this.options_.label || this.localize('');
    };
    ...
    ModalDialog.prototype.description = function description() {
        ...
        //判断是否IE浏览器
  //    var desc = this.options_.description || this.localize('<img src="../facecompare/template/home/img/flash.png" />');
  ...
  var Player = (function (_Component) {
    ...
    Player.prototype.handleTechCanPlay_ = function handleTechCanPlay_() {
      ...
      this.trigger('canplay');
        var that = this;
        setTimeout(function () {
            $(that.el_).siblings(".vjs-black").hide()
        },500)
    };
